...
class CroProSettingsDialog(QDialog):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        self.sentence_min_length = CroProSpinBox(min_val=0, max_val=299, step=1, value=config.sentence_min_length)  # Currently longest sentence has a length of 196 letters (Shirokuma Cafe Outro full sub)
        self.sentence_max_length = CroProSpinBox(min_val=0, max_val=300, step=1, value=config.sentence_max_length)
